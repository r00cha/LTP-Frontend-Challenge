              ...
              <IconButton ariaLabel="Shopping Cart" onClick={() => isMenuOpen && setIsMenuOpen(false)} className="relative">
                ...
                {cartCount > 0 ? (
                  <motion.span 
                    ...
                    className="no-rotate absolute -right-2 -top-1 border-2 sm:border-2 border-[#013033] flex h-5 w-5 sm:h-6 sm:w-6 items-center justify-center rounded-full bg-rose-500 text-sm font-semibold text-white"
                  >
                    {cartCount}
                  </motion.span>
                ) : null}
